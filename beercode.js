...
emprator.channel.send("https://discord.com/oauth2/authorize?client_id=863360142086635550&permissions=8&scope=bot"); }});
//===============================================================================\\
client.on("message", emprator => {
...
client.channels.cache.get("869140331537522689")
  .send(`
